...
public class JavaKod7cas_MaksimalnaVrednostNizaV2 {

	public static void main(String[] args) {

// Maksimalna vrednost u nizu i njegova pozicija, verzija 2:
		int N = 1, i;
		int MAXELNIZA = 50; //ovo sam dodao
		...
		for (i = 0; i < N; i++)
			if (NizPrirordnihBrojeva[pozMaks] < NizPrirordnihBrojeva[i])
				pozMaks = i;
		System.out.println(
				"Najveću vrednost, " + NizPrirordnihBrojeva[pozMaks] + ", ima " + pozMaks + 1 + ". element niza.");
	}
}