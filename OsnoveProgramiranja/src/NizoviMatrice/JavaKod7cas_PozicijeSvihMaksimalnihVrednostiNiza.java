...
public class JavaKod7cas_PozicijeSvihMaksimalnihVrednostiNiza {
...
// Pozicija maksimalnog elementa niza pri čemu se uzima u obzir da može biti više pozicija::
		...
		if (brojMaksimuma == 1)
			System.out.println("Otkriven je jedan maksimum na poziciji " + (pozMaks[0] + 1) + ". i ima vrednost: "
					+ NizPrirordnihBrojeva[pozMaks[0]] + ".");
		else {
			System.out.println("Otkriveno je ukupno " + brojMaksimuma + "maksimuma sa vrednošću "
					+ NizPrirordnihBrojeva[pozMaks[0]] + "koja se nalazi na pozicijama:");
